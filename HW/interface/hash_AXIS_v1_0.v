...
`timescale 1 ns / 1 ps
	...
	(
        ...
        output wire h_wen, h_dout_req,
        output wire [19:0] h_args,
        output wire [31:0] h_din,
        input  wire [31:0] h_dout,
        input  wire h_valid, h_done, h_squeeze_start, 
		// User ports ends
...
// Instantiation of Axi Bus Interface S00_AXI
	hash_AXIS_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) hash_AXIS_v1_0_S00_AXI_inst (
	    .i_lite_reg1(lite_reg1),
	    .o_lite_reg0(lite_reg0),
